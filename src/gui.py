...
class GUI:
    ...
    def __init__(self):
        ...
        self.article_text = tkinter.Text(
            self.article_frame, font=('Arial', 14))
    ...
    def __do_work(self, sender_list, sender_addr_list,
        ...
        text_path, letter_path = core.generate_text_and_letter(sender_list, sender_addr_list,
                                                               receiver_list, receiver_addr_list,
                                                               cc_list, cc_addr_list,
                                                               text)
        core.merge_text_and_letter(text_path, letter_path, output)
